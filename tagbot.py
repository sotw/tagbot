...
def imgTag(tPage):
    ...
    result = []
    target_image = urllib.parse.unquote(tPage)

    im = iio.imread(target_image)
    print(im.shape)
...
def verify():
    ...
    parser = argparse.ArgumentParser(description='A tag bot that target to do some AI')
    parser.add_argument('-v', '--verbose', dest='verbose', action = 'store_true', default=False, help='Verbose mode')
    parser.add_argument('-d', '--database', dest='database', action = 'store', default='/.tagbot/tagbot.db')
    parser.add_argument('-q', '--sqlite3', dest='sql3db', action = 'store', default='/.tagbot/tagbot.db3')
    ...
    parser.add_argument('-m', '--marklastword', dest='marklastword', action = 'store_true', default=False, help='mark last consulted image')
    ...
    parser.add_argument('-k', '--openaikey', dest='oaikey', action = 'store', default='/.tagbot/.oaikey')
